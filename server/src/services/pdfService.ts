...
import { LectureTimetable, ExamTimetable } from '../models/Timetable';

export const generateLectureTimetablePDF = (res: Response, lectures: LectureTimetable[]) => {
...
export const generateExamTimetablePDF = (res: Response, exams: ExamTimetable[]) => {
  const doc = new PDFDocument({ margin: 50 });
